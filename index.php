...
<div role="main" class="main">
		...
		<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.7" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 800, 'gridheight': 760, 'responsiveLevels': [4096,1200,992,500]}">
			<ul>
				<li data-transition="fade">
					...
					<img src="img/slider2.jpg" width="75%" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
				</li>
				<li data-transition="fade">
	...
	<div class="section2">
		<div class="leftSec2">
			...
			<h1 style="line-height: 1.9rem; margin-bottom: 10px; color: white; text-align: left; font-weight: bold; width: 60%; font-size: 1.4rem; text-transform: uppercase ;">
				COMPANY MISSION</h1>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 ml-auto my-auto">
					<img class="img-fluid appear-animation" src="img/datagen.PNG" alt="" data-appear-animation="fadeInUp">
				</div>
			</div>
		</div>
	</section>
...
<!-- <section class="section section-background section-center mt-0" style="background-image: url(img/patterns/swirl_pattern.png); margin-bottom:0;">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-10">
				<h2 class="heading-dark mt-5">Our <strong>Clients</strong></h2>

...
dashBtn.addEventListener("click", () => {
  SideBarButton(dashCard, careerCard, blogCard, galleryCard);
});


careerBtn.addEventListener("click", () => {
  SideBarButton(careerCard, dashCard, blogCard, galleryCard);
});

BaBtn.addEventListener("click", () => {
  SideBarButton(blogCard, dashCard, careerCard, galleryCard);
});

galleryBtn.addEventListener("click", () => {
  SideBarButton(galleryCard, dashCard, careerCard, blogCard);
});

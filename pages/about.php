...
<body>
    ...
    margin-bottom: 0;    margin-top: 1rem;">ABOUT</h2>
            ...
            <div class="section2" style="margin-bottom: 3rem;">
                <div class="leftSec2">
                    <h1 style="letter-spacing: 5px; line-height: 1.9rem; margin-bottom: 10px; color: white; text-align: center; font-weight: bold; width: 50%; font-size: 1.4rem; text-transform: uppercase ;">
                        INTEGRITY</h1>
                    ...
                    <h1 style="letter-spacing: 5px; line-height: 1.9rem; margin-bottom: 0px; color: white; text-align: center; font-weight: bold; width: 50%; font-size: 1.4rem; text-transform: uppercase ;">
                        DEDICATION</h1>
